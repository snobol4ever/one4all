...
typedef enum tree_e {
    ...
    TT_IF,                TT_CASE,              TT_RETURN,            TT_PROC_FAIL,         TT_NRETURN,           TT_LOOP_BREAK,        TT_LOOP_NEXT,         TT_BANG_BINARY,       TT_DEFINE,
...
static const char * const tt_e_name[TT_KIND_COUNT] = {
    ...
    [TT_UNTIL]            = "TT_UNTIL",          [TT_REPEAT]           = "TT_REPEAT",          [TT_FOR]              = "TT_FOR",            [TT_DO_WHILE]         = "TT_DO_WHILE",        [TT_IF]               = "TT_IF",
