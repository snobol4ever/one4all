/*
 * lower_ctx.h — Label table and lowering utilities for lower.c
 *
 * LabelTable: name→SM_Program-instruction-index registry with a forward-
 * reference patch list for SNOBOL4 GOTOs.  GC_MALLOC throughout.
 *
 * Also: kw_canonicalize, expression_scope_walk — shared helpers used by
 * lower.c handlers.
 *
...
/* GC-allocated uppercase copy of raw. */
