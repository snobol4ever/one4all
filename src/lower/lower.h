...
/*
 * lower — compile an TT_PROGRAM node into a flat SM_Program.
 *
 * prog must be an TT_PROGRAM whose children are TT_STMT / TT_END nodes
 ...
 * tree_t trees must remain valid for the duration of this call (lower does not
