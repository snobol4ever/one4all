 ...
 * sm_lower, so interp_eval's TT_FNC label_lookup always returns NULL and
 ...
 * pattern-primitive node kinds (TT_LEN, TT_TAB, TT_BREAK, TT_SPAN, TT_ANY,
 * TT_NOTANY, TT_ARB, TT_ARBNO, TT_REM, TT_FAIL, TT_SUCCEED, TT_FENCE, TT_POS, ...)
...
/* ── ir_dump_program — print TT_PROGRAM as IR sexp — one line per statement.
 * SI-6: walks TT_PROGRAM children, reads fields via stmt_attr_find.
