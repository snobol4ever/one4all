...
/*====================================================================================================================*/
void emit_bb_icon_alt    (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ICN_ALT",     "", icon_alt_new(),     "coro_bb_alternate",   (uint64_t)(uintptr_t)coro_bb_alternate,   s, f, b); }
void emit_bb_icon_bang   (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ICN_BANG",    "", icon_bang_new(),    "coro_bb_bang_binary", (uint64_t)(uintptr_t)coro_bb_bang_binary, s, f, b); }
void emit_bb_icon_every  (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ICN_EVERY",   "", icon_every_new(),   "coro_bb_every",       (uint64_t)(uintptr_t)coro_bb_every,       s, f, b); }
void emit_bb_icon_iterate(emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ICN_ITERATE", "", icon_iterate_new(), "coro_bb_iterate",     (uint64_t)(uintptr_t)coro_bb_iterate,     s, f, b); }
void emit_bb_icon_lconcat(emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ICN_LCONCAT", "", icon_lconcat_new(), "coro_bb_cat",         (uint64_t)(uintptr_t)coro_bb_cat,         s, f, b); }
void emit_bb_icon_limit  (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ICN_LIMIT",   "", icon_limit_new(),   "coro_bb_limit",       (uint64_t)(uintptr_t)coro_bb_limit,       s, f, b); }
void emit_bb_icon_seq    (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ICN_SEQ",     "", icon_seq_new(),     "coro_bb_seq_expr",    (uint64_t)(uintptr_t)coro_bb_seq_expr,    s, f, b); }
void emit_bb_icon_to     (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ICN_TO",      "", icon_to_new(),      "coro_bb_to",          (uint64_t)(uintptr_t)coro_bb_to,          s, f, b); }
void emit_bb_icon_to_by  (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ICN_TO_BY",   "", icon_to_by_new(),   "coro_bb_to_by",       (uint64_t)(uintptr_t)coro_bb_to_by,       s, f, b); }
/*====================================================================================================================*/
void emit_bb_xabrt  (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_jmp_pair("ABORT",  s, f, b, 0); }
void emit_bb_xcat   (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_jmp_pair("CAT",    s, f, b, 1); }
void emit_bb_xfail  (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_jmp_pair("FAIL",   s, f, b, 0); }
void emit_bb_xor    (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_jmp_pair("ALT",    s, f, b, 1); }
void emit_bb_xvar   (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_jmp_pair("VAR",    s, f, b, 1); }
/*====================================================================================================================*/
void emit_bb_xbal   (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("BAL",    "", bb_bal_new(),          "rt_bb_bal",   (uint64_t)(uintptr_t)rt_bb_bal,   s, f, b); }
void emit_bb_xfarb  (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("ARB",    "", bb_arb_new(),          "rt_bb_arb",   (uint64_t)(uintptr_t)rt_bb_arb,   s, f, b); }
void emit_bb_xlnth  (emitter_t *e, long long n,   bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("LEN",  "", bb_len_new((int)n),  "rt_bb_len",  (uint64_t)(uintptr_t)rt_bb_len,  s, f, b); }
void emit_bb_xrtb   (emitter_t *e, long long n,   bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("RTAB", "", bb_rtab_new((int)n), "rt_bb_rtab", (uint64_t)(uintptr_t)rt_bb_rtab, s, f, b); }
void emit_bb_xstar  (emitter_t *e, bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("REM",    "", bb_rem_new(),          "rt_bb_rem",   (uint64_t)(uintptr_t)rt_bb_rem,   s, f, b); }
void emit_bb_xtb    (emitter_t *e, long long n,   bb_label_t *s, bb_label_t *f, bb_label_t *b) { (void)e; emit_bb_stateful("TAB",  "", bb_tab_new((int)n),  "rt_bb_tab",  (uint64_t)(uintptr_t)rt_bb_tab,  s, f, b); }
/*====================================================================================================================*/
void emit_bb_xarbn(emitter_t *e, bb_box_fn child_fn, bb_label_t *s, bb_label_t *f, bb_label_t *b)
{
    (void)e;
    emit_bb_stateful("ARBNO", "", rt_bb_arbno_new(child_fn, NULL), "rt_bb_arbno", (uint64_t)(uintptr_t)rt_bb_arbno, s, f, b);
}
/*====================================================================================================================*/
void emit_bb_xbrkx(emitter_t *e, const char *chars, bb_label_t *s, bb_label_t *f, bb_label_t *b)
{
    (void)e;
...
void emit_bb_xchr(emitter_t *e, PATND_t *p, const char *lit_label,
                  bb_label_t *s, bb_label_t *f, bb_label_t *b)
{
    (void)e;
...
void emit_bb_xrpsi(emitter_t *e, int n, bb_label_t *s, bb_label_t *f, bb_label_t *b)
{
    (void)e;
    char args[32]; snprintf(args, sizeof(args), "%d", n);
