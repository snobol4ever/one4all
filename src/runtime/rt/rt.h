...
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* DAI-8 cluster 3b: rt_halt decl dropped (rt_halt_tos remains). */
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
/* DAI-8 cluster 3b: rt_pop_descr decl dropped (zero callers). */
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
/* DAI-8 cluster 3b: rt_push_real decl dropped (rt_push_real_bits remains). */
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
/*   rt_pl_b_end_register(name, arity) → register completed cfg into g_pl_bb_table and clear builder state    */
...
/* predicate in g_pl_bb_table and calls bb_exec_once on its BB_graph_t directly — does NOT invoke  */
...
/* DAI-8 cluster 3b: rt_patch_cap_fn decl dropped (zero callers). */
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
void rt_init_arbno(void **slot_ptr, void *child_fn);
/* DAI-8 cluster 3b: rt_set_vstack_backend + rt_get_default_vstack_backend decls dropped (zero callers). */
typedef struct {
...
/* DAI-8 cluster 3b: rt_flush_pending_captures decl dropped (zero callers). */
#ifdef __cplusplus
}
#endif
#endif
