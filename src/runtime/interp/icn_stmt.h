/*============================================================================================================================
 * icn_stmt.h — Pure-BB statement-context evaluator for Icon Byrd boxes (RS-17b)
 *
 ...
 * call sites in icn_runtime.c routed through bb_exec_stmt, the kinds that
 ...
 * icn_runtime.c (RS-19).
 *
 * Mirrors the RS-17a icn_value.c convention exactly: a thin trampoline that
