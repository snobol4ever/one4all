/* bb_icn_record_def.c — BB template for BB_ICN_RECORD_DEF.
   ...
   directly to native code for BB_ICN_RECORD_DEF. */
#include "bb_template_common.h"
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
void bb_icn_record_def(void)    { if (IS_X86) return; if (IS_JVM) return; if (IS_JS) return; if (IS_NET) return; if (IS_WASM) return; }
