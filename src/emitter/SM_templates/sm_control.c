...
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* jvm_ret_guard — emit JVM last_ok guard for _S/_F variant; suffix is the skip-label suffix. */
...
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* sm_return — SM_RETURN/S/F: successful return from user function (pushes return value). */
...
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* sm_freturn — SM_FRETURN/S/F: failure return from user function (does not push value). */
...
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* sm_nreturn — SM_NRETURN/S/F: name-return from user function (pushes function-name value). */
