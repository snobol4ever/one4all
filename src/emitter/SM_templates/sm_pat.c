...
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* JVM inner helpers — pop TOS object, coerce to string, invoke pat constructor, push result. */
...
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
void sm_pat_len  (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_long_push(out, "len(J)Lrt/SnoPat;");   if (IS_JS) fprintf(out, "rt.pat_len(); ");   }
void sm_pat_pos  (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_long_push(out, "pos(J)Lrt/SnoPat;");   if (IS_JS) fprintf(out, "rt.pat_pos(); ");   }
void sm_pat_rpos (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_long_push(out, "rpos(J)Lrt/SnoPat;");  if (IS_JS) fprintf(out, "rt.pat_rpos(); ");  }
void sm_pat_tab  (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_long_push(out, "tab(J)Lrt/SnoPat;");   if (IS_JS) fprintf(out, "rt.pat_tab(); ");   }
void sm_pat_rtab (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_long_push(out, "rtab(J)Lrt/SnoPat;");  if (IS_JS) fprintf(out, "rt.pat_rtab(); ");  }
void sm_pat_arb  (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_noarg_push(out, "arb()Lrt/SnoPat;");    if (IS_JS) fprintf(out, "rt.pat_arb(); ");   }
void sm_pat_rem  (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_noarg_push(out, "rem()Lrt/SnoPat;");    if (IS_JS) fprintf(out, "rt.pat_rem(); ");   }
void sm_pat_bal  (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_noarg_push(out, "bal()Lrt/SnoPat;");    if (IS_JS) fprintf(out, "rt.pat_bal(); ");   }
void sm_pat_fence0(const SM_Instr * instr, FILE * out){ (void)instr; if (IS_JVM) jvm_pat_noarg_push(out, "fence0()Lrt/SnoPat;"); if (IS_JS) fprintf(out, "rt.pat_fence(); ");  }
void sm_pat_abort(const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_noarg_push(out, "abort_()Lrt/SnoPat;"); if (IS_JS) fprintf(out, "rt.pat_abort(); ");  }
void sm_pat_fail (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_noarg_push(out, "fail_()Lrt/SnoPat;");  if (IS_JS) fprintf(out, "rt.pat_fail(); ");  }
void sm_pat_succeed(const SM_Instr * instr, FILE * out){(void)instr; if (IS_JVM) jvm_pat_noarg_push(out, "succeed_()Lrt/SnoPat;");if (IS_JS) fprintf(out, "rt.pat_succeed(); ");}
void sm_pat_eps  (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_noarg_push(out, "eps()Lrt/SnoPat;");    if (IS_JS) fprintf(out, "rt.pat_eps(); ");   }
void sm_pat_deref(const SM_Instr * instr, FILE * out) { (void)instr;
...
void sm_pat_arbno(const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_pat_push(out, "arbno(Lrt/SnoPat;)Lrt/SnoPat;"); if (IS_JS) fprintf(out, "rt.pat_arbno(); "); }
void sm_pat_fence1(const SM_Instr * instr, FILE * out){ (void)instr; if (IS_JVM) jvm_pat_pat_push(out, "fence1(Lrt/SnoPat;)Lrt/SnoPat;"); }
void sm_pat_cat  (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_2pat_push(out, "cat(Lrt/SnoPat;Lrt/SnoPat;)Lrt/SnoPat;");  if (IS_JS) fprintf(out, "rt.pat_cat(); "); }
void sm_pat_alt  (const SM_Instr * instr, FILE * out) { (void)instr; if (IS_JVM) jvm_pat_2pat_push(out, "alt(Lrt/SnoPat;Lrt/SnoPat;)Lrt/SnoPat;");  if (IS_JS) fprintf(out, "rt.pat_alt(); "); }
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
