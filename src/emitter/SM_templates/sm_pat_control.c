...
void sm_pat_fence0(void) {
    ...
    if (IS_JS) { emit_textf("rt.pat_fence(); "); return; }
    /* IS_NET: n/a — NET PAT stub */
    if (IS_WASM) { emit_textf("          (call $sno_pat_fence)\n"); return; }
}
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
void sm_pat_abort(void) {
    ...
    if (IS_JS) { emit_textf("rt.pat_abort(); "); return; }
    /* IS_NET: n/a — NET PAT stub */
    if (IS_WASM) { emit_textf("          (call $sno_pat_abort)\n"); return; }
}
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
void sm_pat_fail(void) {
    ...
    if (IS_JS) { emit_textf("rt.pat_fail(); "); return; }
    /* IS_NET: n/a — NET PAT stub */
    if (IS_WASM) { emit_textf("          (call $sno_pat_fail)\n"); return; }
}
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
void sm_pat_succeed(void) {
    ...
    if (IS_JS) { emit_textf("rt.pat_succeed(); "); return; }
    /* IS_NET: n/a — NET PAT stub */
    if (IS_WASM) { emit_textf("          (call $sno_pat_succeed)\n"); return; }
}
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
void sm_pat_arbno(void) {
    ...
    if (IS_JS) { emit_textf("rt.pat_arbno(); "); return; }
    /* IS_NET: n/a — NET PAT stub */
    if (IS_WASM) { emit_textf("          (call $sno_pat_arbno)\n"); return; }
}
