...
pass=0
fail=0
for case in smoke_interp sm_interp_test si_06_exp si_07_pat_lit si_08_prim_pats si_09_pat_fns si_11_compare si_12_call_builtin si_13_proc si_14_computed_goto si_15a_literals si_15b_arith si_15c_pat_replace si_16_cond_return ; do
