 ...
 * A linear-bounded automaton can recognize it — and so can SNOBOL4-tiny,
 ...
 *
 * In SNOBOL4-tiny this maps to the nPush/nInc/nTop/nPop action nodes
 ...
 *   1. SNOBOL4-tiny can recognize a Type 1 language — something no PDA
